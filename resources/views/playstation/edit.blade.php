                ...
                <form method="POST" action="/playstation/{{ $play->id }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('harga_normal') is-invalid @enderror"
                            id="harga_normal" name="harga_normal" required autofocus
                            value="{{ old('harga_normal', $play->harga_normal) }}">
                        @error('harga_normal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('harga_member') is-invalid @enderror"
                            id="harga_member" name="harga_member" required autofocus
                            value="{{ old('harga_member', $play->harga_member) }}">
                        @error('harga_member')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
